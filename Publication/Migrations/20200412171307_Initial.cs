        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<int>(nullable: false),
                    PublicationCartId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicationCartItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PublicationCartItems_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublicationCartItems_BookId",
                table: "PublicationCartItems",
                column: "BookId");
        }
